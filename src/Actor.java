...
class Actor extends Point {
  ...
  enum ai {
    NONE, TOPLAYER, TOPOINT, TORANDOM
  }

  enum interaction {
    NONE, COLLIDE, PUSH, PULL, TALK, HIT, PORT
  }
  ...
  /*
   * ***** AI Types ********* 0 do nothing 1 move toward player 2 move toward
   * (xDest,yDest) 3 move random***********************
   */
  ...
  boolean hasInteraction() {
    return (_interaction != interaction.NONE);
  }
  ...
  boolean isPushable() {
    return (_interaction == interaction.PUSH);
  }
